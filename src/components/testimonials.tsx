...
const testimonials = [
  {
    ...
    title: "Time Traveler",
    quote:
      "Thanks to get-current-day, I always know what day it is, even when I’m lost in time.",
  },
  {
    ...
    quote:
      "With get-current-day, I can manage my time-turner schedule effortlessly.",
  },
  {
  ...
  },
  {
    ...
    title: "Time Lord",
    quote:
      "Even a Time Lord needs to know the current day. get-current-day is fantastic!",
  },
  {
    ...
    title: "Inventor",
    quote:
      "Great Scott! get-current-day is the best tool for keeping track of time.",
  },
  {
    ...
    quote:
      "Leaping through time is easier with get-current-day. Highly recommended!",
  },
];
  ...
  return (
    <div>
      <p className="max-w-lg text-sm/6 text-gray-600">
        Join the fun and start using get-current-day to always know what day it
        is.
      </p>
      <div className="mt-2">
        <Link
